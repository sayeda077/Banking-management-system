...
<label>Phone Number</label><input type="text" name="phone_number" id="phone_number"><br/><br/>
...
<label>Join Date</label><input type="text" name="join_date" id="join_date"><br/><br/>
