...
<html>
<head>
	<title>sign_up form for giving loan</title>
</head>
<body>
	<table>
		<form action="borrower(destination).php" method="post">
			<tr>
				<td>Customer Id:</td>
			...
			<tr>
				<td>loan ammount:</td>
				<td><input type="text" name="loan_ammount"></td>
			</tr>
			<tr>
				<td>Date of taking loan:</td>
				<td><select name="year">
					<option>year</option>
					<option>2014</option>
					<option>2015</option>
